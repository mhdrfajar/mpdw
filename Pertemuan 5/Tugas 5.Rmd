...
Plot deret waktu di atas menunjukkan bahwa data tidak stasioner dalam rataan, ditandai dengan data yang membentuk pola trend dan tidak stasioner dalam ragam, ditandai dengan lebar pita yang cenderung tidak sama.
...
Berdasarkan plot ACF, terlihat bahwa plot ACF pada data tersebut cenderung *slowly tails off*. Hal ini dapat mengindikasikan bahwa data cenderung tidak stasioner.
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **0.792** dan pada selang kepercayaan 95% nilai memiliki batas bawah **0.730** dan batas atas **0.855**. Selang tersebut tidak memuat nilai satu sehingga tidak dapat dikatakan bahwa data bangkitan stasioner dalam ragam.
