...
ggplot() + 
  ...
  labs(x = "Periode Waktu", y = "High_Stock", color = "Legend") +
...
Pada kasus ini, dari keempat metode yang telah dicobakan, metode Double Moving Average (DMA) dengan m=5 memberikan peramalan yang paling baik karena nilai MAPE yang dihasilkan merupakan yang terkecil, baik pada data latih maupun pada data uji.