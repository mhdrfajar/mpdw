...
vif(model2)
```
Setelah membuang peubah $x_4$ dari model awal, didapatkan model terbaru dengan *VIF* \< 10 pada setiap peubah bebasnya. Artinya tidak terdapat multikolinearitas pada model yang terbaru.
